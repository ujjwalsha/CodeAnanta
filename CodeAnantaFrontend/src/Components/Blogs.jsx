  ...
  return (
    <>

      {
        ...
        <div className='mt-5 p-2 grid grid-cols-1 gap-2 lg:grid-cols-4'>
        {
            Blog.length ? 
            (
              Blog.map((blog) =>(
                <div className='flex justify-center  items-center mt-10' id={blog.id}>
                  ...
                  <div className='flex flex-col items-center p-3 gap-2 rounded-sm bg-gray-900'>
                      ...
                      <button 
                        ...
                        className='bg-purple-400 cursor-pointer hover:bg-purple-600 w-full text-sm rounded-sm text-white p-2 '
                      >Read more</button>
                  </div>
